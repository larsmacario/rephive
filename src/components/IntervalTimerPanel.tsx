...
export interface IntervalTimerPanelProps {
  onSaveSession: (input: SaveSessionInput) => Promise<void>;
  variant?: "screen" | "sheet";
}

export function IntervalTimerPanel({ onSaveSession, variant = "screen" }: IntervalTimerPanelProps) {
  ...
  const ringSize = isSheet ? 200 : 232;
  const bigFontSize = isSheet ? 68 : 84;
    ...
    <>
      ...
      <div
        style={{
          ...
          minHeight: isSheet ? 220 : 0,
          flex: isSheet ? undefined : 1,
          padding: isSheet ? "12px 0 8px" : undefined,
        }}
      >
        <Ring
          size={ringSize}
